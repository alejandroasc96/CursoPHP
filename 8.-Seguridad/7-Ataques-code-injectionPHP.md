...
1.  [Introducción](#id1)
2.  [Mostrar el código al público](#id2)
3.  [Ataques RFI Remote File Inclusion](#id3)
4.  [Inyección por expresiones regulares](#id4)
5.  [Funciones vulnerables a Code Injection](#id5)
...
## 2. Mostrar el código al público <a name="id2"></a>
...
## 3. Ataques RFI Remote File Inclusion <a name="id3"></a>
...
## 4. Inyección por expresiones regulares <a name="id4"></a>
...
## 5. Funciones vulnerables a Code Injection <a name="id5"></a>
